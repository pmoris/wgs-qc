...
for r1 in "${trimmed_fastq_dir}"/*_R1_001.trim.fastq.gz; do
    ...
    # sample_name=$(basename "${read_1}" "_R1_001.trim.fastq.gz")
    ...
    # # generate stats
    # samtools index --threads "${n_threads}" "${bam_dir}/${sample_name}.sort.bam"
    # samtools stats --threads "${n_threads}" "${bam_dir}/${sample_name}.sort.bam" >"${bam_dir}/${sample_name}.sort.bam.stats"
    # samtools flagstat --threads "${n_threads}" "${bam_dir}/${sample_name}.sort.bam" >"${bam_dir}/${sample_name}.sort.bam.flagstat"
    # samtools idxstats --threads "${n_threads}" "${bam_dir}/${sample_name}.sort.bam" >"${bam_dir}/${sample_name}.sort.bam.idxstats"
